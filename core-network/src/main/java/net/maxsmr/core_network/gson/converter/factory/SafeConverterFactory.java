...
public class SafeConverterFactory {
    ...
    private Map<Class, SafeConverter> initializedSafeConverters;

    public SafeConverterFactory(@NotNull Map<Class, SafeConverter> safeConverters) {
        this.initializedSafeConverters = new HashMap<>(safeConverters);
    }
